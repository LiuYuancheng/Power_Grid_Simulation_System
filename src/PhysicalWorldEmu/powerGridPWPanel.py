...
class PanelCtrl(wx.Panel):
    ...
    def _buildUISizer(self):
        ...
        sizer.AddSpacer(10)
        sizer.Add(wx.StaticLine(self, wx.ID_ANY, size=(140, -1),
    ...
    def _buildSolarCtrl(self, sizer, flagsL):
        ...
        solarlabel = wx.StaticText(self, label="Solar Gen Control")
    ...
    def _buildWindCtrl(self, sizer, flagsL):
        # wind system control
        windlabel = wx.StaticText(self, label="Wind Gen Control")
        windlabel.SetFont(wx.Font(10, wx.DECORATIVE, wx.NORMAL, wx.BOLD))
        sizer.Add(windlabel, flag=flagsL, border=2)
        sizer.AddSpacer(10)

        self.windPwCB = wx.CheckBox(self, label = 'Wind Panel Gen Power')
        ...
        self.windSwCB = wx.CheckBox(self, label = 'Wind Panel Switch')
    ...
    def _buildPowerPlantCtrl(self, sizer, flagsL):
        ...
        sizer.Add(wx.StaticText(self, label="Gennerator-01 Control:"), flag=flagsL, border=2)
        sizer.AddSpacer(5)
        ...
        sizer.Add(wx.StaticText(self, label="Gennerator-02 Control:"), flag=flagsL, border=2)
        sizer.AddSpacer(5)
        ...
        sizer.Add(wx.StaticText(self, label="Gennerator-03 Control:"), flag=flagsL, border=2)
        sizer.AddSpacer(5)
