...
# Name:        hmiMapMgr.py
#
# Purpose:     The management module to control all the components on the SCADA
#              HMI map panel  and update the components state. 
# 
...
class MapMgr(object):
    ...
    def __init__(self, parent):
        ...
        self.loads = []
        self._initLoads()
        # Agent item mapping to the PLC coil idx
        ...
        # User selected item's ID and name 
        self.selectedID = None
        self.selectedItemName= None

    #-----------------------------------------------------------------------------
    # define all the item init function here
    ...
    def setItemsPwrState(self, registList):
        """Get the Item's state based on the PLC register data list."""
